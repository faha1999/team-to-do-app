...
const demoProjects: Project[] = [
  ...
  },
  {
    id: 'proj_ops',
    name: 'Operations',
    description: 'Finance & vendor ops.',
    visibility: 'PRIVATE',
    status: 'ACTIVE',
    open: 9,
    overdue: 0,
...
export default function TeamProjectsPage({
  ...
  const filtered = useMemo(() => {
    ...
    if (sort === 'open') arr.sort((a, b) => b.open - a.open);
    return arr;
  }, [projects, q, visibility, status, sort]);
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Browse all projects in this team workspace.
            </p>
          </div>
          <Link
            href={`/teams/${teamId}`}
